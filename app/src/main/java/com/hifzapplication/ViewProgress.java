...
public class ViewProgress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db= new DatabaseHelper(ViewProgress.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                obj2=new AssignTasks();



                if (start1.isEmpty()||end1.isEmpty()){
                    Toast.makeText(ViewProgress.this, "Please Fill the Required Fields", Toast.LENGTH_SHORT).show();

                } else if (start>end) {
                    Toast.makeText(ViewProgress.this, "Start Should be less than end", Toast.LENGTH_SHORT).show();
                } else if (start==end) {
                    Toast.makeText(ViewProgress.this, "Start Should be equal to end", Toast.LENGTH_SHORT).show();
                } else if (start<=currentsabaqend) {
                    Toast.makeText(ViewProgress.this, "This ayat is already done please start with "+(student.getSabaq_end()+1), Toast.LENGTH_SHORT).show();
                } else if (start>currentsabaqend+1) {
                    Toast.makeText(ViewProgress.this, "You left some ayat behind please start with "+(student.getSabaq_end()+1), Toast.LENGTH_SHORT).show();
                } else if (end+obj.getParahStart(currentpara-1)>=obj.getParahStart(currentpara)) {
                    Toast.makeText(ViewProgress.this, "this para only has "+(obj.getParahStart(currentpara)-obj.getParahStart(currentpara-1)-1)+" ayats", Toast.LENGTH_SHORT).show();
                } else if ((obj.getParahStart(currentpara-1)-obj.getParahStart(currentpara)-1)==currentsabaqend) {
                    Toast.makeText(ViewProgress.this, "Para No "+currentpara+" is completed , Start with second Para", Toast.LENGTH_SHORT).show();
                    db.updatePara(student.getId(), currentpara);
                } else{
                    db.updateSabaqRange(student.getId(),start,end);
                    Toast.makeText(ViewProgress.this, "Work Assigned", Toast.LENGTH_SHORT).show();
